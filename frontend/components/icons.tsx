// Lightweight inline SVG icons (no external dependency). Each uses currentColor
// so it inherits text colour, and accepts a className for sizing.
...
export function IconFollowUps({ className }: IconProps) {
  return (
    <svg {...base(className)}>
